...
OUTPUT_JSON = "results/initial_audit.json"
...
for idx in range(len(df)):
    ...
    results[subgroup]["positive_total"] += 1
    ...
    results[subgroup]["negative_total"] += 1
...
print("\nInitial fairness audit completed\n")
